...
// Key points on axis and wall
Point(1)  = {0,     0,   0,   1};  // axis inlet
Point(2)  = {4.8,   0,   0,   1};  // wall inlet
Point(3)  = {0,     0,   7.5, 1};  // axis throat
Point(4)  = {1.5,   0,   7.5, 1};  // wall throat
Point(5)  = {0,     0, 107.5, 1};  // axis exit
Point(6)  = {2.075, 0, 107.5, 1};  // wall exit
Point(7)  = {0,     0, 367.5, 1};  // axis far
Point(8)  = {2.075, 0, 367.5, 1};  // wall far (inner)
Point(9)  = {10,    0, 107.5, 1};  // ambient side at exit
Point(10) = {10,    0, 367.5, 1};  // ambient side far

// Convergent wall spline points
Point(11) = {3.90,  0,  2.0, 1};
Point(12) = {2.80,  0,  4.5, 1};
Point(13) = {2.00,  0,  6.2, 1};

// Divergent wall spline points
